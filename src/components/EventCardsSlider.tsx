      ...
      <div className="flex gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          {props.venueName && (
            <div className="flex items-center gap-2 flex-wrap mb-2" onClick={(e) => e.stopPropagation()}>
              <Link
                ...
                className="text-base font-semibold text-indigo-400 hover:text-indigo-300 hover:underline line-clamp-1"
              >
                {props.venueName}
              </Link>
              <FollowButton
          ...
          {(props.venueInstagram || props.venueWebsite || props.promoterInstagram || props.promoterWebsite) && (
            <div className="flex items-center gap-3 mt-2 pt-2 border-t border-slate-700/50" onClick={(e) => e.stopPropagation()}>
