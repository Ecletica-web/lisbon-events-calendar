...
export default function MobileListHeader({
  ...
  return (
    <div className="space-y-3 mb-4">
      <div className="flex border-2 border-terminus-strong overflow-x-auto scrollbar-hide">
        ...
        <div className="flex items-center gap-2 shrink-0">
          {onClearFilters && (
            <button
              ...
              className="text-xs font-medium text-terminus-fg-muted hover:text-terminus-fg transition-colors underline underline-offset-2 touch-manipulation"
            >
              Clear all filters
            </button>
          )}
          <span className="text-xs text-terminus-fg-muted">
